...
export const INFORMATION_SECURITY_POLICY_SPEC: DocumentTemplateSpec = {
  ...
  forbiddenInferences: ["names of people", "ISMS committee", "nonexistent roles", "cloud suppliers", "dates", "frequencies", "numeric objectives", "KPI", "RTO/RPO", "tools", "held certifications", "scope exclusions", "signatories"],
