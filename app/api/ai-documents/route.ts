...
async function getDocumentsData(workspaceId: string) {
  ...
  const [evidenceResult, aiDocumentsResult, argumentsResult] = await Promise.all([
    client.from("evidence_items")
      ...
      .in("document_type", [
        ...
        "backup_and_recovery_policy", "information_asset_management_policy", "backup_restore_procedure", "asset_management_policy",
      ]),
